...
const About = () => {
  useEffect(() => {
    ...
    return () => {
      clipAnimation.kill(); // Cleanup animation on unmount
    };
  }, []);
  ...
  return (
    <div id="about" className="min-h-screen w-screen">
      ...
      <div className="relative mb-8 mt-36 flex flex-col items-center gap-5">
        <p className="text-2xl uppercase md:text-2xl">Welcome to Edify</p>
        ...
        <div className="about-subtext !text-2xl">
          ...
          <p className="text-gray-500">
            Whether you're a beginner or a professional, Edify AI is your partner in mastering new
            skills, building networks, and stepping into the future.
          </p>
        </div>
      </div>
