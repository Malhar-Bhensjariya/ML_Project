  ...
  return (
    <div id="contact" className="my-20 min-h-96 w-screen  px-10">
      <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
        ...
        <ImageClipBox src={contact2} clipClass="contact-clip-path-2 lg:translate-y-40 translate-y-60" />
        </div>

        <div className="absolute -top-40 left-20 w-60 sm:top-1/2 md:left-auto md:right-10 lg:top-20 lg:w-80">
        <ImageClipBox src={feature6} clipClass="absolute md:scale-125" />
        <ImageClipBox src={feature6} clipClass="sword-man-clip-path md:scale-125" />
        </div>
